...
export default function SettingsPage() {
		...
		if (originalData) {
			...
			const dataChanged = Object.keys(originalData).some((key) => {
				if (
					...
					return false;
				return (
					originalData[key as keyof ProfileDataWithPassword] !==
					profileData[key as keyof ProfileDataWithPassword]
				);
			});
	...
	const handleProfileDataChange = (
		field: keyof ProfileDataWithPassword,
		value: string
	) => {
		setProfileData((prev) => ({
			...prev,
	...
	const validateForm = () => {
		...
		// Password validation
		if (!isOAuthUser && profileData.newPassword) {
	...
	const handleProfileUpdate = async () => {
		...
		try {
			...
			// Only add password fields for non-OAuth users
			if (!isOAuthUser && profileData.newPassword) {
			...
			if (updateData.password) {
				toast({
					...
					description:
						"Your password has been updated successfully. You'll need to sign in again.",
					variant: "default",
					duration: 5000,
								...
								<div className='grid gap-4 mt-3 md:grid-cols-2'>
									...
									<div className='space-y-2'>
										...
										<Select
											...
											onValueChange={(value) =>
												handleProfileDataChange("gender", value)
											}
										>
											<SelectTrigger>
									...
									<div className='space-y-2'>
										...
										<Input
											...
											onChange={(e) =>
												handleProfileDataChange("height", e.target.value)
											}
									...
									<div className='space-y-2'>
										...
										<Input
											...
											onChange={(e) =>
												handleProfileDataChange("weight", e.target.value)
											}
								...
								<div className='grid gap-4 mt-3 md:grid-cols-2'>
									<div className='space-y-2'>
										...
										<Select
											...
											onValueChange={(value) =>
												handleProfileDataChange("fitnessGoal", value)
											}
										>
											<SelectTrigger>
									...
									<div className='space-y-2'>
										...
										<Select
											...
											onValueChange={(value) =>
												handleProfileDataChange("activityLevel", value)
											}
										>
											<SelectTrigger>
									...
									<div className='space-y-2'>
										...
										<Select
											...
											onValueChange={(value) =>
												handleProfileDataChange("experienceLevel", value)
											}
										>
											<SelectTrigger>
									...
									<div className='space-y-2'>
										...
										<Select
											...
											onValueChange={(value) =>
												handleProfileDataChange("preferredWorkoutType", value)
											}
										>
											<SelectTrigger>
						...
						<CardFooter className='flex flex-col sm:flex-row justify-between gap-4'>
							<Button
								...
								className={`w-full sm:w-auto ${
									hasChanges ? "bg-red-500 hover:bg-red-600" : "bg-red-300"
								}`}
							>
								{saving ? (
									<>
									...
									<div className='flex items-start gap-4'>
										...
										<div>
											...
											<p className='text-muted-foreground mt-1'>
												Your account is secured with Google authentication. You
												don't need a password to sign in - just use the "Sign in
												with Google" button.
											</p>
										</div>
									</div>
									...
									<div className='grid gap-4 md:grid-cols-2'>
										<div className='space-y-2'>
											...
											<Input
												...
												onChange={(e) =>
													handleProfileDataChange("password", e.target.value)
												}
										...
										<div className='space-y-2'>
											...
											<Input
												...
												onChange={(e) =>
													handleProfileDataChange("newPassword", e.target.value)
												}
												className={
